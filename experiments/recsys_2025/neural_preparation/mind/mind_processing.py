...
input_folder =  './mind_input'

# Step 1: Load Mind-small dataset behaviors
train_behaviors_path = os.path.join(input_folder, 'behaviors_train.tsv')
val_behaviors_path = os.path.join(input_folder, 'behaviors_val.tsv')

behaviors_column_names = ['Impression ID', 'User ID', 'Time', 'History', 'Impressions']

df_train_behaviors = pd.read_csv(train_behaviors_path, sep='\t', encoding='utf-8', header=None, names=behaviors_column_names)

df_val_behaviors = pd.read_csv(val_behaviors_path, sep='\t', encoding='utf-8', header=None, names=behaviors_column_names)



dataset_result_folder =  './mind_results'
