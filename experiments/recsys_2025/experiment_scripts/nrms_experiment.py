...
# This script demonstrates the experiment of the NRMS model.
#
# 1. Data Preparation:
...
#    - Combines the NRMS model, metrics in a Cornac `Experiment`.
...
def main():
    ...
    experiment_output_path = f'./experiment_{dataset_name}_nrms_results'
