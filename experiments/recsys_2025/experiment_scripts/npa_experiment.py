...
# This script demonstrates the experiment of the NPA model.
#
# 1. Data Preparation:
...
#    - Combines the NPA model, metrics in a Cornac `Experiment`.
...
def main():
    ...
    experiment_output_path = f'./experiment_{dataset_name}_npa_results'
